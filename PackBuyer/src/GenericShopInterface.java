...
public class GenericShopInterface extends ComponentCentered implements ItemGroup {
	...
	public boolean isVisible() {
		...
		// Match by expected shop title (substring match)
	...
	public UIResult<Integer> getSelectedAmount() {
		...
		String t = core.getOCR()
				...
				.replaceAll("[^0-9]", "");
		if (t.isEmpty()) {return UIResult.of(null);}
	...
	public boolean setSelectedAmount(int amount) {
		...
		if (!selected.isNotVisible() && selected.get() != null && selected.get() == amount) {return true;}
	...
	@Override
	public int groupWidth() {return 8;}
	
	@Override
	public int groupHeight() {return 4;}
	
	@Override
	public int xIncrement() {return 47;}
	
	@Override
	public int yIncrement() {return 47;}
	
	@Override
	public Rectangle getGroupBounds() {return getBounds();}
	
	@Override
	public ScriptCore getCore() {return core;}
}
